...
update yes_seat_type set
    seat_color = '#9076FF'
where seat_color = 'indianred';

update yes_seat_type set
    seat_color = '#FF8AB4'
where seat_color = 'darkslateblue';

update yes_seat_type set
    seat_color = '#70D0EA'
where seat_color = 'mediumpurple';
...
----------------------------------- 예매 테이블 - Reservation -----------------------------------
-- 예매 테이블
drop table yes_reserve cascade constraints purge;
...
,status_cng_date    date default sysdate                   -- 수정일자
