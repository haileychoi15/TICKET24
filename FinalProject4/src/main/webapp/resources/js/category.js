...
function getProductTemplate(selectNum) {
	var categoryNum = getParameter('category');
	var categoryDetail = getParameter('categoryDetail');
	alert(categoryNum);
	
	$.ajax({
		url:"<%= request.getContextPath()%>/selectList.action",
		type:"GET",
		data:{"selectNum":selectNum,
			  "categoryNum":categoryNum,
			  "detailCategoryNum":categoryDetail},
		dataType:"JSON",
