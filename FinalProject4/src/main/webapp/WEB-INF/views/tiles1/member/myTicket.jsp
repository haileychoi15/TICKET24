...
<div id="container">
                      ...
                      <td>
                          <div class="showInfoBox">
                              <div class="show_poster">
                                  <img src="resources/images/${my.prod_img }" alt="poster" width="90px">
                              </div>
    ...
    <div id="reviewDiv">
      ...
      <div class="autoDiv reviewContentDiv">
        <div id="content">
           <c:forEach varStatus="status" var="review" items="${myReviewList}">
               <div class="reviewBox">
                   <img src="resources/images/${review.prod_img }" alt="poster" height="110px">
                   <div class="review">
        ...
        <div id="preferredArea">
           <c:forEach var="like" items="${myLikeList }" varStatus="status">
              <div class="preferredItem">
                 <img src="resources/images/${like.prod_img }" alt="poster" width="170px" onclick="javascript:location.href='/finalproject4/detail.action?seq=${like.prod_id }'" style="cursor:pointer">
