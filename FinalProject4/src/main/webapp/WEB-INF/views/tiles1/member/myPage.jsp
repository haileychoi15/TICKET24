...
<script src="https://kit.fontawesome.com/c3eca5a54c.js"
...
<body>
   <div id="container">
      <div id="top">
         <div class="myInfo">
            <div class="imgDiv">
               <img src="resources/images/myInfo.png" alt="myInfoImg" width="80px">
            </div>
            <div id="idDiv">
               <div class="myInfo">
                  ...
                  <div id="logout">
                     <button type="button"
                        onclick="location.href='<%=ctxPath%>/logout.action'">로그아웃</button>
                  </div>
               </div>
               <div class="aDiv">
                  <a href="<%=ctxPath%>/modifyInfo.action" id="modifyInfo">&nbsp;정보
                     수정</a>
               </div>
            </div>
         </div>
         <div id="myPoint">
            ...
            <div class="emDiv">
               <span class="em" id="point"><fmt:formatNumber
                     value="${sessionScope.loginuser.point}" pattern="###,###" /></span>원
            </div>
         </div>
         <div id="myCoupon">
            ...
            <div class="emDiv">
               <span class="em" id="coupon">${couponCount}</span>개
            </div>
         </div>
         <div id="myQNA">
            ...
            <div class="emDiv">
               <span class="em" id="qna">${qnaCount}</span>개
            </div>
         </div>
      </div>
               ...
               <tbody>
                  <c:forEach var="point" items="${pointList}" varStatus="status">
                     <tr>
                        ...
                        <td class="point"><fmt:formatNumber value="${point.point }"
                              pattern="###,###" />원</td>
                     </tr>
                  </c:forEach>
               </tbody>
               ...
               <tbody>
                  ...
                  <c:forEach var="coupon" items="${couponList}" varStatus="status">
                     <tr>
                        ...
                        <td class="point"><fmt:formatNumber
                              value="${coupon.coupon_dc }" pattern="###,###" />원 할인</td>
                  ...
                  <c:if test="${qna2.admin_content != null}">
                     <div class="modalTitle answerDiv">
                        <div class="answerTitle">
                           <img src="resources/images/TICKET24.png" alt="TICKET24"
                              width="20px">&nbsp;TICKET24 고객센터
                        </div>
